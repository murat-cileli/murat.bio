...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      ...
      { icon: 'youtube', link: 'https://www.youtube.com/@muratsretroplay' },
      { icon: 'youtube', link: 'https://www.youtube.com/@istemci' },
    ],
