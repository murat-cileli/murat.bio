...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      ...
      { icon: 'youtube', link: 'https://www.youtube.com/@muratsretroplay?sub_confirmation=1' },
      { icon: 'youtube', link: 'https://www.youtube.com/@istemci?sub_confirmation=1' },
    ],
